...
const Prototype = () => {
  ...
  const [segmentationResponse, setSegmentationResponse] = useState(null); // SAM-2 API data response
  const [getRequestData, setGetRequestData] = useState(null); // Store the GET request response
